...
get.arbitrary.seq <- function(tree, model, l = 1000, gamma.parameter = 1.0406, invprop = 0, rootseq = NULL){
	...
	if(length(grep("gtr", model)) > 0){
		...
		#three <- a[3] - a[2]
		#four <- 1 - a[3]
		#basef <- c(one, two ,three, four)
		basef <- c(0.2628, 0.2605, 0.2436, 0.2331)
                qmat <- c(1.3472, 4.8145, 0.9304, 1.2491, 5.5587, 1)
